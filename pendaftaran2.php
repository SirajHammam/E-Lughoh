    ...
    if( tambah($_POST) > 0) {  
      echo "
            <script>
                ...
                document.location.href = 'pendaftaran2.php';
            </script>
        ";
    } else {
        echo "
        ...
        <div class="card-body">
          <form class="row g-3" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
              ...
              <input type="text" name="nameA" class="form-control" id="nameA" placeholder="Enter Your Name">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-4">
              ...
              <input type="text" name="prodi" class="form-control" id="Major" placeholder="Your Major">
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-3">
              ...
              <input type="text" name="hp" class="form-control" id="hp" placeholder="Your life..">
            </div>
            <div class="col-md-6">
